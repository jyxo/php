...
{
	/**
	 * Creates array containing item range. Similar to range() but with closures.
	 ...
	 * @param \Closure $compare Optional comparing closure for detecting if we're at the end of range
	 * @return array
	 */
	...
	/**
	 * Creates associative array from iterator which doesn't return proper keys.
	 * Keys are generated by applying callback $key to current value.
	 * It is also possible to apply another callback directly to value.
	 ...
	 * @param \Closure $key Closure for generating key
	 * @param \Closure $value Optional closure for modifying data
	 * @return array
	 */
